...
public class BusinessNotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_notes);
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    fab.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            //Implement an explicit intent for opening the Business Editor activity
                            Intent intent = new Intent(getApplicationContext(),BusinessNotesActivity.class);
            ...
            HashSet<String> set3 = (HashSet<String>) sharedPreferences.getStringSet("notes",null);

            if(set3 == null){
                notes.add(" Business Meeting at 1300hrs with Henry");
            } else {

                notes = new ArrayList(set3);
            }
            ...
            listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    new AlertDialog.Builder(BusinessNotes.this)
